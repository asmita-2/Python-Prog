###This code plots data points in three dimension space to make them look seperable by passing them through a tranform function.
...
##ques) Plot the points. Then transform these points using a “Transform” function into 3-dim space. Plot the points and
## manipulate the points so that you can see a separating plane in 3D.

##plotting  the points in 3-d space.
...
###converting the data into 3-d function.
